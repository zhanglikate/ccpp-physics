...
!> @{
      subroutine GFS_MP_generic_post_run(                                                                                 &
        ...
        imp_physics_mg, imp_physics_fer_hires, cal_pre, cplflx, cplchm, cplchp, con_g, rainmin, dtf, frain, rainc,        &
...
!
      ...
      logical, intent(in) :: cal_pre, lssav, ldiag3d, qdiag3d, cplflx, cplchm,cplchp
