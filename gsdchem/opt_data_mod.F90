...
!
      !water
      real(kind_phys),dimension(1:nswbands),save ::  refrwsw,refiwsw
      real(kind_phys),dimension(1:nlwbands),save ::  refrwlw,refiwlw
      ...
      !dust
      real(kind_phys),dimension(1:nswbands),save ::  refrsw_dust,refisw_dust
      real(kind_phys),dimension(1:nlwbands),save ::  refrlw_dust,refilw_dust
...
!     data refisw_dust /nswbands*0.003/   ! SAM 7/24/11 original imaginary index for dust in visible
      ...
      !BC
      real(kind_phys),dimension(1:nswbands),save ::  refrsw_bc,refisw_bc
      real(kind_phys),dimension(1:nlwbands),save ::  refrlw_bc,refilw_bc
      ...
      !OC
      real(kind_phys),dimension(1:nswbands),save ::  refrsw_oc,refisw_oc
      real(kind_phys),dimension(1:nlwbands),save ::  refrlw_oc,refilw_oc
      ...
      !Sea-salt
      real(kind_phys),dimension(1:nswbands),save ::  refrsw_seas,refisw_seas
      real(kind_phys),dimension(1:nlwbands),save ::  refrlw_seas,refilw_seas
      ...
      !Sulfate 
      real(kind_phys),dimension(1:nswbands),save ::  refrsw_sulf,refisw_sulf
      real(kind_phys),dimension(1:nlwbands),save ::  refrlw_sulf,refilw_sulf
...
!*************************************************************
      !wavelength
      real(kind_phys), save :: wavmin(nswbands) ! Min wavelength (um) of interval
      !data wavmin /3.077,2.500,2.150,1.942,1.626,1.299, &
      data wavmin /0.25,0.35,0.55,0.998/
      real(kind_phys), save :: wavmax(nswbands) ! Max wavelength (um) of interval
      !data wavmax/3.846,3.077,2.500,2.150,1.942,1.626, &
      data wavmax/0.35,0.45,0.65,1.000/
      real(kind_phys), save :: wavenumber1_longwave(nlwbands) !Longwave limits (cm-1)
      data wavenumber1_longwave /10.,350.,500.,630.,700.,820.,980.,1080.,1180.,1390.,1480.,1800.,2080.,2250.,2390.,2600./
      real(kind_phys), save :: wavenumber2_longwave(nlwbands) !Longwave limits (cm-1)
      ...
      real(kind_phys),parameter :: rmmin=0.005e-4,rmmax=50.e-4  ! cm 
      real(kind_phys),save:: refrtabsw(prefr,nswbands)
      real(kind_phys),save:: refitabsw(prefi,nswbands)
      real(kind_phys),save:: refrtablw(prefr,nlwbands)
      real(kind_phys),save:: refitablw(prefi,nlwbands)
      !coefficients for parameterizing aerosol radiative properties
      !in terms of refractive index and wet radius
      real(kind_phys),save:: extpsw(ncoef,prefr,prefi,nswbands) !specific extinction
      real(kind_phys),save:: abspsw(ncoef,prefr,prefi,nswbands) !specific absorption
      real(kind_phys),save:: ascatpsw(ncoef,prefr,prefi,nswbands) !specific scattering
      real(kind_phys),save:: asmpsw(ncoef,prefr,prefi,nswbands) !asymmetry factor
      real(kind_phys),save:: sbackpsw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: pmom2psw(ncoef,prefr,prefi,nswbands) 
      real(kind_phys),save:: pmom3psw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: pmom4psw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: pmom5psw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: pmom6psw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: pmom7psw(ncoef,prefr,prefi,nswbands)
      real(kind_phys),save:: extplw(ncoef,prefr,prefi,nlwbands) !specific extinction
      real(kind_phys),save:: absplw(ncoef,prefr,prefi,nlwbands) !specific absorption
      real(kind_phys),save:: ascatplw(ncoef,prefr,prefi,nlwbands) !specific scattering
      real(kind_phys),save:: asmplw(ncoef,prefr,prefi,nlwbands) !asymmetry factor

      real(kind_phys),save :: wavmidsw(nswbands)
      ...
      real(kind_phys),save :: wavmidlw(nlwbands)
